...
void showFileNames(){
	...
	for (i=1; i<nfile; i++){
		if (i == sel & (tick%2==0)){
			...
			ILI9341_WriteString(10,(3+i)*SPACER, filenames[i], Font_7x10,BG_COLOR,MAIN_FONT_COLOR);
		} else {
			ILI9341_WriteString(10,(3+i)*SPACER, filenames[i], Font_7x10,MAIN_FONT_COLOR,BG_COLOR);
		}
	}
}
