...
int main(void)
{
  ...
  HAL_TIM_Base_Start_IT(&htim2);
  {
	  ...
	  HAL_UART_Transmit(&CONSOLE_UART_HANDLE, "\n" , 1, 0xFFFF);
	  HAL_UART_Transmit(&CONSOLE_UART_HANDLE, "-------------------------------\n" , 32, 0xFFFF);
	  HAL_UART_Transmit(&CONSOLE_UART_HANDLE, "------PIN CONNECTION TEST------\n" , 32, 0xFFFF);
	  HAL_UART_Transmit(&CONSOLE_UART_HANDLE, "-------------------------------\n" , 32, 0xFFFF);
  }
  freeRTOS_ready = true;
  /* USER CODE END 2 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : PE4 PE5 PE3 PE1
                           PE6 PE2 PE0 PE7
                           PE12 PE8 PE9 PE15
                           PE11 PE14 PE10 PE13 */
  GPIO_InitStruct.Pin = GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_3|GPIO_PIN_1
                          |GPIO_PIN_6|GPIO_PIN_2|GPIO_PIN_0|GPIO_PIN_7
                          |GPIO_PIN_12|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_15
                          |GPIO_PIN_11|GPIO_PIN_14|GPIO_PIN_10|GPIO_PIN_13;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : PB9 PB6 PB7 PB5
                           PB0 PB11 PB14 PB2
                           PB10 PB1 PB12 PB15 */
  GPIO_InitStruct.Pin = GPIO_PIN_9|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_5
                          |GPIO_PIN_0|GPIO_PIN_11|GPIO_PIN_14|GPIO_PIN_2
                          |GPIO_PIN_10|GPIO_PIN_1|GPIO_PIN_12|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PD6 PD5 PD4 PD1
                           PD7 PD0 PD3 PD14
                           PD10 PD9 PD13 PD15
                           PD11 PD12 PD8 */
  GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_1
                          |GPIO_PIN_7|GPIO_PIN_0|GPIO_PIN_3|GPIO_PIN_14
                          |GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_13|GPIO_PIN_15
                          |GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_8;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : PC14 PC11 PC10 PC15
                           PC13 PC8 PC9 PC2
                           PC0 PC1 PC6 PC7
                           PC3 PC5 PC4 */
  GPIO_InitStruct.Pin = GPIO_PIN_14|GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_15
                          |GPIO_PIN_13|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_2
                          |GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_6|GPIO_PIN_7
                          |GPIO_PIN_3|GPIO_PIN_5|GPIO_PIN_4;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : PA12 PA11 PA10 PA9
                           PA8 PA0 PA2 PA4
                           PA3 PA5 PA6 PA7 */
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_9
                          |GPIO_PIN_8|GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_4
                          |GPIO_PIN_3|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PF0 PF1 PF9 PF10
                           PF2 */
